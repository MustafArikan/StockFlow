...
namespace backend.Migrations
{
    ...
    [Migration("20260811072226_AddIsFeaturedToAttributeRule")]
    partial class AddIsFeaturedToAttributeRule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stok_takip.Models.ImportHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_import_histories_user_id");
            ...
            modelBuilder.Entity("stok_takip.Models.User", b =>
                {
                    ...
                    b.Property<int>("FailedPasswordResetAttempts")
                        .HasColumnType("int")
                        .HasColumnName("failed_password_reset_attempts");
                    ...
                    b.Property<DateTime?>("LastFailedPasswordResetAttempt")
                        .HasColumnType("datetime2")
                        .HasColumnName("last_failed_password_reset_attempt");

                    b.Property<DateTime?>("LastFailedVerificationAttempt")
                        .HasColumnType("datetime2")
                        .HasColumnName("last_failed_verification_attempt");
            ...
            modelBuilder.Entity("stok_takip.Models.ImportHistory", b =>
                {
                    b.HasOne("stok_takip.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_import_histories_users_user_id");
